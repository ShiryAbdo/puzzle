...
import com.swaqny.crossword.puzzl.challenge.models.GameAchievement;
            ...
            if (mGameMode != null) {
                switch (mGameMode.getDifficulty()) {
                    ...
                    case GameDifficulty.Hard6:
                        mLeaderboardId = getString(R.string.leaderboard_highest_scores__hard6);
                        break;
                    case GameDifficulty.Hard7:
                        mLeaderboardId = getString(R.string.leaderboard_highest_scores__hard7);
                        break;
                    case GameDifficulty.Hard8:
                        mLeaderboardId = getString(R.string.leaderboard_highest_scores__hard8);
                        break;
                    case GameDifficulty.Hard9:
                        mLeaderboardId = getString(R.string.leaderboard_highest_scores__hard9);
                        break;
                    case GameDifficulty.Hard10:
                        mLeaderboardId = getString(R.string.leaderboard_highest_scores__hard10);
                        break;
    ...
    private void updateAchievements() {
        ...
        switch (mGameMode.getDifficulty()) {
            ...
            case GameDifficulty.Hard:
                ...
                break;
            case GameDifficulty.Hard6:
                achievementsMap = GameAchievement.HARDACHIEVEMENTSMAP6;
                break;
            case GameDifficulty.Hard7:
                achievementsMap = GameAchievement.HARDACHIEVEMENTSMAP7;
                break;
            case GameDifficulty.Hard8:
                achievementsMap = GameAchievement.HARDACHIEVEMENTSMAP8;
                break;
            case GameDifficulty.Hard9:
                achievementsMap = GameAchievement.HARDACHIEVEMENTSMAP9;
                break;
            case GameDifficulty.Hard10:
                achievementsMap = GameAchievement.HARDACHIEVEMENTSMAP10;
                break;
